        ...
        <nav className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-slate-900">muratakar.net</span>
            </Link>
      ...
      <footer className="bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* About */}
            <div>
              <h3 className="text-xl font-bold mb-4">Murat Akar</h3>
              <p className="text-slate-400 leading-relaxed">
                Modern teknolojiler ve yaratıcı çözümler üzerine çalışan bir profesyonelim.
              </p>
            </div>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center">
            <p className="text-slate-400">
              © {new Date().getFullYear()} Murat Akar. Tüm hakları saklıdır.
            </p>
          </div>
        </div>
      </footer>
